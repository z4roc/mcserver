        ...
        <div className="container mx-auto p-4">
            ...
            <div className="flex items-center gap-6 mb-6">
                ...
                <div>
                    ...
                    <div className="flex justify-between">
                        ...
                        <p className="text-lg text-gray-500">
                            created: {new Date(modpack.dateCreated).toLocaleDateString("de-DE", {
                            year: "2-digit",
                            month: "2-digit",
                            day: "2-digit",
                        })}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-xl font-bold">{modpack.downloadCount.toLocaleString()}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                    ...
                    <CardContent>
                        <Button >Deploy</Button> {/* TODO Dialog for Deployment*/}
                    </CardContent>
                </Card>
            </div>
        </div>
